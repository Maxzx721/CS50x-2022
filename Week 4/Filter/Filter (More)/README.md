...
![image](https://user-images.githubusercontent.com/70191060/181580663-f90bacd2-413e-4af2-8243-836ee44f3776.png)
...
![image](https://user-images.githubusercontent.com/70191060/181580877-70f09e39-2959-48c0-bc77-a3dfe7f19d44.png)
...
![image](https://user-images.githubusercontent.com/70191060/181581347-cf899763-fecb-4f5f-be11-6ec9bd0df263.png)
...
![image](https://user-images.githubusercontent.com/70191060/181585914-ae55d9aa-9939-4369-976e-02038ee7fdc7.png)
...
https://youtu.be/K0v9byp9jd0?list=PLhQjrBD2T3837jmUt0ep7Tpmnxdv9NVut
...
- [x] :) helpers.c exists
- [x] :) filter compiles
- [x] :) grayscale correctly filters single pixel with whole number average
- [x] :) grayscale correctly filters single pixel without whole number average
- [x] :) grayscale leaves alone pixels that are already gray
- [x] :) grayscale correctly filters simple 3x3 image
- [x] :) grayscale correctly filters more complex 3x3 image
- [x] :) grayscale correctly filters 4x4 image
- [x] :) reflect correctly filters 1x2 image
- [x] :) reflect correctly filters 1x3 image
- [x] :) reflect correctly filters image that is its own mirror image
- [x] :) reflect correctly filters 3x3 image
- [x] :) reflect correctly filters 4x4 image
- [x] :) blur correctly filters middle pixel
- [x] :) blur correctly filters pixel on edge
- [x] :) blur correctly filters pixel in corner
- [x] :) blur correctly filters 3x3 image
- [x] :) blur correctly filters 4x4 image
- [x] :) edges correctly filters middle pixel
- [x] :) edges correctly filters pixel on edge
- [x] :) edges correctly filters pixel in corner
- [x] :) edges correctly filters 3x3 image
- [x] :) edges correctly filters 4x4 image
