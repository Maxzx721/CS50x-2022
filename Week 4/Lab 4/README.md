...
- [x] :) volume.c exists
- [x] :) volume.c compiles
- [x] :) reduces audio volume, factor of 0.5 correctly
- [x] :) reduces audio volume, factor of 0.1 correctly
- [x] :) increases audio volume, factor of 2 correctly
